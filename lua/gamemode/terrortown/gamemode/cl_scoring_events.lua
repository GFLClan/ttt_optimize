...
-- Icons we'll use
local smile_icon   = _Material("icon16/emoticon_smile.png")
local magnifier_icon = _Material("icon16/magnifier.png")
local bomb_icon    = _Material("icon16/bomb.png")
local wrong_icon   = _Material("icon16/cross.png")
local right_icon   = _Material("icon16/tick.png")
local shield_icon  = _Material("icon16/shield.png")
local star_icon    = _Material("icon16/star.png")
local app_icon     = _Material("icon16/application.png")
local credit_icon = _Material("icon16/coins.png")
local wrench_icon  = _Material("icon16/wrench.png")
...
local function GetWeaponName(gun)
   ...
   if _tonumber(gun) then
      wname = EnumToWep(gun)
   elseif _isstring(gun) then
